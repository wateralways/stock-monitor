...
def generate_strategy_doc():
    strategies = [
        ...
        },
        {
            ...
            "color": "#D35400",
            "stocks": ["高澜股份"],
            "win_rates": {"高澜股份(5日跌)": "81.8%", "高澜股份(10日跌)": "100%"},
            "entry": "5日累计跌幅>10%(T+0/T+5) 或 10日累计跌幅>15%(T+1/T+4)",
            "exit": "5日跌信号: 持仓5天尾盘卖 | 10日跌信号: 持仓3天开盘卖",
            "timing": "5日跌>10%: T+0尾盘买/T+5尾盘卖 | 10日跌>15%: T+1开盘买/T+4开盘卖",
            "description": "专为高澜股份设计的深跌反弹策略。高澜股份深跌后反弹确定性极高：5日跌>10%后买入22笔81.8%胜率+6.1%平均收益；10日跌>15%更是8笔全赢+7.9%平均收益。替代原RSI布林带策略(50%/+0.03%)。",
        },
    ]
