...
def generate_strategy_doc():
    strategies = [
        ...
        },
        {
            ...
            "win_rates": {"川润股份": "75.0%(T+9)", "裕同科技": "100%(T+9)", "拓日新能": "64.7%(T+7)", "ST炼石": "66.7%(T+5)", "华夏航空": "85.7%(T+6)", "英维克": "80.0%(T+8)", "佳力图": "70.0%(T+9)"},
            "entry": "近5日低点 > 近15日低点(底部抬高) 且 近3日量均>近10日量均*1.2(温和放量) 且 RSI14在45-65(中性偏多) 且 今日收阳",
            "exit": "按差异化持仓期到期卖出",
            "timing": "川润/裕同/佳力图 T+1/T+9 | 英维克 T+1/T+8 | 拓日新能 T+1/T+7 | 华夏航空 T+1/T+6 | ST炼石 T+1/T+5",
            "description": "捕捉横盘震荡后加速上涨的机会。区别于深跌反弹(抓超跌)，本策略识别'反弹后→横盘酝酿→温和放量突破'的形态。7只股票差异化持仓期: 川润+7.28%(8笔75%), 裕同+7.83%(7笔100%), 拓日+9.77%(17笔64.7%), ST炼石+4.12%(6笔66.7%), 华夏航空+3.97%(7笔85.7%), 英维克+2.52%(5笔80%), 佳力图+4.04%(10笔70%)。",
        },
    ]
