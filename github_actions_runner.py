...
def generate_strategy_doc():
    strategies = [
        ...
        },
        {
            ...
            "description": "捕捉连续下跌后的超跌反弹机会。川润股份同时参考T+0/T+4(胜率76.5%)和T+0/T+5(62.5%)两个持仓期。扬农化工和拓日新能使用固定RSI<=35阈值。",
        },
        {
            "id": 5,
            "name": "动量策略",
        ...
        },
        {
            ...
            "name": "深跌反弹",
            "color": "#D35400",
            "stocks": ["高澜股份", "川润股份", "江淮汽车", "爱乐达"],
            "win_rates": {"高澜(跌5%+RSI+涨)": "100%", "高澜(跌10%)": "81.8%", "川润(跌5%+RSI+涨)": "70.0%", "江淮(跌10%)": "76.9%", "爱乐达": "73.7%"},
            "entry": "信号A: 5日跌>5% & RSI14<40 & 当日涨 | 信号B: 5日跌>10%(仅高澜/江淮/爱乐达)",
            "exit": "信号A: 3-4天后卖出 | 信号B: 5天后尾盘卖",
            "timing": "爱乐达信号A: T+0/T+3开盘卖 | 其他信号A: T+0/T+4尾盘卖 | 信号B: T+0/T+5尾盘卖(江淮T+1/T+6)",
            "description": "深跌后的超跌反弹策略。信号A(5日跌>5%+RSI超卖+当日涨)适用全部4只股票；信号B(5日跌>10%)仅限高澜/江淮/爱乐达。爱乐达综合胜率73.7%，信号A用T+0/T+3(盈亏比4.74)，信号B用T+0/T+5(100%胜率)。",
        },
    ]
