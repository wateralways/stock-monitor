    ...
    strategies = [
        {
            ...
            "win_rates": {"爱乐达": "83.3%", "ST炼石": "65.4%", "高澜股份": "50.0%"},
            "entry": "自适应RSI阈值(根据波动率动态计算，约20-45)或布林带位置低于自适应阈值(约0.1-0.6)，且当日上涨收阳。爱乐达等需MA20趋势未明显下行(5日斜率>-1%)，ST股和高澜股份免过滤",
            "exit": "RSI > 自适应卖出阈值(约50-70) 或 布林带位置 > 0.75",
            "timing": "T+1开盘买入，T+6开盘卖出",
            "description": "利用RSI超卖和布林带下轨支撑，捕捉短期反弹机会。引入自适应参数系统，根据近期波动率(20日/60日波动率比值)动态调整买卖阈值，高波动时条件更严格。爱乐达等增加MA20趋势过滤避免下跌趋势抄底；ST股和高澜股份适合逆势抄底，免除趋势过滤。",
        },
        {
            "id": 2,
            "name": "MA支撑+KDJ超卖",
        ...
        },
        {
            ...
            "color": "#E74C3C",
            "stocks": ["川润股份", "英维克", "爱乐达"],
            "win_rates": {"川润股份": "59.3%", "英维克": "50.0%", "爱乐达": "64.7%"},
